...
<!DOCTYPE html>
    ...
    <body>
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="carrito.php">CARRITO <?php echo"$_SESSION[carrito]";?></a>
                        </li>               
                    </ul>
                </div>  
        ...
        <main class="mainMenuPlatos">
            <section id="fondoMenuPlatos" class="">
                    <h2 class="h2MenuPlatos" >MENÚ SANDOVAL</h2>
                    <div class="container" id="contenedorMenuPlatos" >
                        <div class="row" id="hola">
                            <div class="col-12 col-md-12">
                                <img src="imagenes/hamburguesas2.jpg" alt="">
                                <img src="imagenes/pizzas2.jpg" alt="">
                                <img src="imagenes/papas2.jpg" alt="">
                                <img src="imagenes/picadas2.jpg" alt="">
                            </div>
                        </div>
                    </div>   
            </section>
